                            ...
                            <table cellpadding="10">
                                <tr>
                                    ...
                                    <td valign="top">
                                        ...
                                        &nbsp
                                        <font size=-2 face="Courier New"><a href="<dsp:valueof param="
                                                                            element.downloadURL"/>">Download</a></font>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td valign="top">
                                        <font face="Courier New">
                                            <dsp:droplet name="/atg/dynamo/droplet/Switch">
                                                <dsp:param param="element.type" name="value"/>
                                        ...
                                        <dsp:droplet name="/atg/dynamo/droplet/IsEmpty">
                                            ...
                                            <dsp:oparam name="false">
                                                ...
                                                <dsp:form action="song.jsp" method="post">
                                                    ...
                                                    <%-- this is here so that if the page is redisplayed, it will know
                                                    which song
                                                    item to display --%>
